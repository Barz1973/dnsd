<template>
  <div>
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="card text-white" style="background-image: linear-gradient(to right, blue, red)">
      ...
      <div class="col-md-3">
        <div class="card" style="background-image: linear-gradient(to right, blue, red)">
    ...
    <table class="table table-hover">
      <thead style="background-image: linear-gradient(to right, blue, red)">
        <tr class="text-white">
          <th>Full Name</th>
          <th>Email</th>
          <th>Address</th>
